"""
It provides a logger class for the Crawly application.
...
class Crawly_Logger:
    """
    This class manages a logger instance for the Crawly application.
    ...
    Attributes:
        ...
        __configurator (Logger_Configurator): A class to configure logging settings for the Crawly application.
    ...
    def __init__(
        ...
        """
        Initializing the Crawly_Logger instance.
